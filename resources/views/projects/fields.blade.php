...
<div class="form-group col-sm-12 col-lg-12">
    ...
    {!! Form::textarea('description', null, ['class' => 'form-control myText']) !!}
</div>
...
<script>
    tinymce.init({
        ...
        selector: '.myText',
        plugins: ' code preview importcss searchreplace autolink autosave save directionality code visualblocks visualchars fullscreen image link media template codesample table charmap pagebreak nonbreaking anchor insertdatetime advlist lists wordcount help charmap quickbars emoticons',
